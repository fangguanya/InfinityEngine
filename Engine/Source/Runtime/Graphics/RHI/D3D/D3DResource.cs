...
namespace InfinityEngine.Graphics.RHI.D3D
{
    ...
    public unsafe class FD3DBuffer : FRHIBuffer
    {
        ...
        internal FD3DBuffer(FRHIDevice device, in FBufferDescriptor descriptor) : base(device, descriptor)
        {
            ...
            // GPU Memory
            if ((descriptor.storageType & EStorageType.Default) == EStorageType.Default || (descriptor.storageType & EStorageType.Dynamic) == EStorageType.Dynamic || (descriptor.storageType & EStorageType.Static) == EStorageType.Static)
            {
    ...
    public unsafe class FD3DTexture : FRHITexture
    {
        ...
        internal FD3DTexture(FRHIDevice device, in FTextureDescriptor descriptor) : base(device, descriptor)
        {
            ...
            if ((descriptor.storageType & EStorageType.Default) == EStorageType.Default)
            {
                ...
                D3D12_RESOURCE_DESC defaultResourceDesc;
                {
                    defaultResourceDesc.Dimension = descriptor.textureType.GetNativeDimension();
                    defaultResourceDesc.Alignment = 0;
            ...
            if ((descriptor.storageType & EStorageType.Static) == EStorageType.Static || (descriptor.storageType & EStorageType.Dynamic) == EStorageType.Dynamic)
            {
                ...
                D3D12_RESOURCE_DESC uploadResourceDesc;
                {
                    uploadResourceDesc.Dimension = descriptor.textureType.GetNativeDimension();
                    uploadResourceDesc.Alignment = 0;
            ...
            if ((descriptor.storageType & EStorageType.Staging) == EStorageType.Staging)
            {
                ...
                D3D12_RESOURCE_DESC readbackResourceDesc;
                {
                    readbackResourceDesc.Dimension = descriptor.textureType.GetNativeDimension();
                    readbackResourceDesc.Alignment = 0;
